    ...
    if (!(window.MathJax && MathJax.Hub)) {
        ...
        (function (d) {
            ...
            b.Object = c({
                ...
                Subclass: function (f, h) {
                    ...
                    Init: function () {}, SUPER: function (f) {
        ...
        MathJax.Hub = {
            ...
            Config: function (a) {
                ...
                Process: function (a) {}, Update: function (b) {
        ...
        MathJax.Hub.Startup = {
            ...
            Config: function () {
                ...
                this.queue.Push(["ConfigDelay", this], ["ConfigBlocks", this], [
                    function (d) {
        ...
        (function (d) {
            ...
            var g = MathJax.Object.Subclass({
                ...
                }, Startup: function () {}, loadComplete: function (i) {
                    if (i === "config.js") {
                        return a.loadComplete(this.directory + "/" + i)
                    } else {
                        var h = f.Queue();
                        h.Push(c.Register.StartupHook("End Config", {}), ["Post", c.Startup.signal, this.id + " Jax Config"], ["Config", this], ["Post", c.Startup.signal, this.id + " Jax Require"], [
                            function (j) {
                            ...
                            this.config || {},
                            this.id
                        ], ["Post", c.Startup.signal, this.id + " Jax Startup"], ["Startup", this], ["Post", c.Startup.signal, this.id + " Jax Ready"]);
